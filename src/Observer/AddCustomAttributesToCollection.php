<?php
/**
 * FlipDev_CustomAttributes Observer - Add Custom Attributes to Collection
 *
 * Adds virtual custom attributes to product collections (used by Firebear exports)
 *
 * @category  FlipDev
...
class AddCustomAttributesToCollection implements ObserverInterface
{
    /**
     * @var PriceHelper
     */
    ...
    /**
     * Add custom attributes to product collection
     *
    ...
    public function execute(Observer $observer): void
    {
        ...
        try {
            foreach ($collection as $product) {
                $this->addCustomAttributesToProduct($product);
            }
        } catch (\Exception $e) {
            $this->logger->error(
                'FlipDev_CustomAttributes: Error adding attributes to collection: ' . $e->getMessage()
            );
        }
    }
     ...
     * @return void
     */
    private function addCustomAttributesToProduct($product): void
    {
        try {
